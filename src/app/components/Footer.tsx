    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="font-['Poppins',sans-serif] text-sm mt-3 leading-relaxed" style={{ color: "#99a1af" }}>
              ALANN Enterprises LLC— AI-powered classified marketplace for vehicles, electronics, furniture, and services across the UAE.
            </p>
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              <a href="tel:+97 1505951024" className="flex items-center gap-2 text-sm transition-colors hover:text-white" style={{ color: "#99a1af", fontFamily: "Poppins, sans-serif" }}>
                <Phone size={14} />
                +97 1505951024
              </a>
        ...
        >
          ...
          <p className="font-['Poppins',sans-serif] text-xs" style={{ color: "#99a1af" }}>
            © 2025 Alann Enterprises LLC. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
