      ...
      <section className="pb-24 px-6">
        ...
        >
          ...
          <LegalSection title="8. Limitation of Liability">
            <p>To the maximum extent permitted by UAE law, ALANN Enterprises LLC shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Platform.</p>
          </LegalSection>
